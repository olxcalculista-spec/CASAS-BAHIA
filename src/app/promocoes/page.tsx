...
import { ShoppingCart, Star, Filter, Search, Plus, Minus, X, CreditCard, Smartphone, Banknote, Calendar, Lock, User, MapPin, Phone, Building, Settings, Eye, EyeOff, Copy, Check, Tag, Zap, Clock, Gift } from 'lucide-react';
import { Product, CartItem, Category, PaymentMethod, CustomerData, PaymentData, BankAccount } from '@/lib/types';
import QRCode from 'qrcode';

// Produtos em PROMOÇÕES ESPECIAIS - Mix de categorias
const promocoesProducts: Product[] = [
  {
    id: 'promo1',
    name: 'Smart TV Samsung 75" QLED 4K Q80C',
    price: 4999.99,
  ...
  {
    id: 'promo3',
    name: 'Geladeira Brastemp Side by Side 540L Inverse Inox',
    price: 3799.99,
  ...
  {
    id: 'promo4',
    name: 'Notebook Gamer Acer Nitro 5 RTX 4060 16GB 512GB',
    price: 4299.99,
  ...
  {
    id: 'promo5',
    name: 'Ar Condicionado Split Inverter Daikin 24000 BTUs',
    price: 2699.99,
    ...
    reviews: 345,
    discount: 31,
    installments: { count: 12, value: 224.99 }
  },
  {
    id: 'promo6',
    name: 'Máquina de Lavar Samsung 15kg Ecobubble Inox',
    price: 2199.99,
  ...
  {
    id: 'promo7',
    name: 'Soundbar Samsung HW-Q990C 11.1.4 Dolby Atmos',
    price: 3499.99,
  ...
  {
    id: 'promo8',
    name: 'Aspirador Robô Roomba j7+ com Esvaziamento Automático',
    price: 2799.99,
    ...
    reviews: 298,
    discount: 30,
    installments: { count: 12, value: 233.33 }
  },
  {
    id: 'promo9',
    name: 'Cafeteira Expresso Nespresso Vertuo Next Premium',
    price: 799.99,
  ...
  {
    id: 'promo10',
    name: 'Air Fryer Philips Walita Airfryer XXL 7.3L',
    price: 899.99,
  ...
  {
    id: 'promo11',
    name: 'Console PlayStation 5 Slim 1TB + 2 Controles',
    price: 3999.99,
    originalPrice: 4999.99,
  ...
  {
    id: 'promo12',
    name: 'Micro-ondas Panasonic Inverter 32L Inox com Grill',
    price: 799.99,
    originalPrice: 1199.99,
    image: 'https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=400&h=300&fit=crop',
    category: 'promocoes',
  ...
  {
    id: 'promo13',
    name: 'Purificador de Água Electrolux PE12B Branco',
    price: 599.99,
  ...
  {
    id: 'promo14',
    name: 'Ventilador de Teto Spirit 203 LED 3 Pás Preto',
    price: 399.99,
  ...
  {
    id: 'promo15',
    name: 'Batedeira Planetária KitchenAid Stand Mixer 4.8L',
    price: 1999.99,
...
export default function PromocoesPage() {
  ...
  const filteredProducts = useMemo(() => {
    return promocoesProducts.filter(product => {
...
🙏 Obrigado pela preferência!`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      {/* Header */}
      <header className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-2xl sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">PROMOÇÕES ESPECIAIS</h1>
                <p className="text-blue-100 text-sm">Produtos selecionados com descontos incríveis</p>
              </div>
            </div>
            ...
            >
              ...
              {cartItemsCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-yellow-400 text-blue-800 text-xs font-bold rounded-full h-6 w-6 flex items-center justify-center animate-pulse">
                  {cartItemsCount}
                </span>
              )}
            </button>
      ...
      {/* Banner de Promoções */}
      <div className="bg-gradient-to-r from-green-400 to-blue-500 text-white py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center space-x-4 text-center">
            <Gift className="h-6 w-6 animate-bounce" />
            <p className="font-bold text-lg">🎁 PROMOÇÕES ESPECIAIS - PRODUTOS SELECIONADOS COM SUPER DESCONTOS! 🎁</p>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center justify-center bg-gradient-to-r from-blue-100 to-indigo-100 rounded-xl p-3">
              <Gift className="h-5 w-5 text-blue-600 mr-2" />
              <span className="font-semibold text-blue-800">{filteredProducts.length} promoções ativas</span>
            </div>
          </div>
        </div>
          ...
          {filteredProducts.map((product) => (
            <div key={product.id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 hover:scale-105 group">
              ...
              <div className="relative">
                ...
                />
                <div className="absolute top-3 left-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-3 py-1 rounded-full text-sm font-bold animate-pulse">
              ...
              <div className="p-4">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg"
                >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <input
                        ...
                        className="col-span-2 px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                      <input
                        type="text"
                        placeholder="Número"
                ...
                <div>
                  ...
                  <button
                    ...
                    className="w-full mt-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105"
                  >
