...
// Produtos em LIQUIDAÇÃO com descontos ainda maiores
const liquidacaoProducts: Product[] = [
  ...
  {
    id: 'liq7',
    name: 'Forno Elétrico de Embutir 65L Inox Fischer',
    price: 1299.99,
  ...
  {
    id: 'liq8',
    name: 'Robô Aspirador iRobot Roomba i7+ com Base',
    price: 1799.99,
  ...
  {
    id: 'liq10',
    name: 'Máquina de Café Expresso Nespresso Vertuo',
    price: 599.99,
  ...
  {
    id: 'liq13',
    name: 'Churrasqueira Elétrica George Foreman 15 Porções',
    price: 299.99,
  ...
  {
    id: 'liq15',
    name: 'Panela de Pressão Elétrica Mondial 6L Inox',
    price: 199.99,
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">LIQUIDAÇÃO TOTAL</h1>
                <p className="text-purple-100 text-sm">Descontos de até 50% OFF - Últimas peças!</p>
              </div>
            </div>
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-red-500 text-white py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center space-x-4 text-center">
            ...
            <p className="font-bold text-lg">🚨 LIQUIDAÇÃO FINAL - ATÉ 50% OFF - ÚLTIMAS UNIDADES! 🚨</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Buscar na liquidação..."
                value={searchTerm}
            ...
            <div className="flex items-center justify-center bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-3">
              ...
              <span className="font-semibold text-purple-800">{filteredProducts.length} produtos em liquidação</span>
            </div>
          </div>
        </div>
